import{s as R,g as lt,r as $,l as st,a4 as Q,o as k,a,b as s,w as n,Q as z,e as U,aw as X,ap as M,c as A,a3 as B,f as F,Z as q,a2 as H,t as w,a0 as j,a1 as G,a5 as tt,a6 as it,h as rt}from"./index-BDHRj4vo.js";import{Q as et}from"./QSelect-DrVp5keO.js";import{Q as at}from"./QForm-CuqvoJMD.js";import{c as J,Q as Z,a as V,b as D}from"./QList-CaAa8emQ.js";import{Q as dt}from"./QChip-CrGGWLfl.js";import{Q as nt}from"./QMarkupTable-Bjwy_M78.js";import{Q as ct}from"./QPage-BQI_wm3w.js";import{Q as ut}from"./QSpace-Co36cdnZ.js";import{h as C}from"./moment-C5S46NFB.js";import"./format-BdCZ0ncF.js";var _={},ot;function pt(){if(ot)return _;ot=1,Object.defineProperty(_,"__esModule",{value:!0}),_.Printd=_.createIFrame=_.createLinkStyle=_.createStyle=void 0;var O=/^(((http[s]?)|file):)?(\/\/)+([0-9a-zA-Z-_.=?&].+)$/,i=/^((\.|\.\.)?\/)([0-9a-zA-Z-_.=?&]+\/)*([0-9a-zA-Z-_.=?&]+)$/,f=function(d){return O.test(d)||i.test(d)};function h(d,t){var o=d.createElement("style");return o.appendChild(d.createTextNode(t)),o}_.createStyle=h;function b(d,t){var o=d.createElement("link");return o.type="text/css",o.rel="stylesheet",o.href=t,o}_.createLinkStyle=b;function g(d){var t=window.document.createElement("iframe");return t.setAttribute("src","about:blank"),t.setAttribute("style","visibility:hidden;width:0;height:0;position:absolute;z-index:-9999;bottom:0;"),t.setAttribute("width","0"),t.setAttribute("height","0"),t.setAttribute("wmode","opaque"),d.appendChild(t),t}_.createIFrame=g;var u={parent:window.document.body,headElements:[],bodyElements:[]},m=function(){function d(t){this.isLoading=!1,this.hasEvents=!1,this.opts=[u,t||{}].reduce(function(o,c){return Object.keys(c).forEach(function(p){return o[p]=c[p]}),o},{}),this.iframe=g(this.opts.parent)}return d.prototype.getIFrame=function(){return this.iframe},d.prototype.print=function(t,o,c,p){if(!this.isLoading){var y=this.iframe,L=y.contentDocument,E=y.contentWindow;if(!(!L||!E)&&(this.iframe.src="about:blank",this.elCopy=t.cloneNode(!0),!!this.elCopy)){this.isLoading=!0,this.callback=p;var x=E.document;x.open(),x.write('<!DOCTYPE html><html><head><meta charset="utf-8"></head><body></body></html>'),this.addEvents();var Y=this.opts,I=Y.headElements,T=Y.bodyElements;Array.isArray(I)&&I.forEach(function(r){return x.head.appendChild(r)}),Array.isArray(T)&&T.forEach(function(r){return x.body.appendChild(r)}),Array.isArray(o)&&o.forEach(function(r){r&&x.head.appendChild(f(r)?b(x,r):h(x,r))}),x.body.appendChild(this.elCopy),Array.isArray(c)&&c.forEach(function(r){if(r){var P=x.createElement("script");f(r)?P.src=r:P.innerText=r,x.body.appendChild(P)}}),x.close()}}},d.prototype.printURL=function(t,o){this.isLoading||(this.addEvents(),this.isLoading=!0,this.callback=o,this.iframe.src=t)},d.prototype.onBeforePrint=function(t){this.onbeforeprint=t},d.prototype.onAfterPrint=function(t){this.onafterprint=t},d.prototype.launchPrint=function(t){this.isLoading||t.print()},d.prototype.addEvents=function(){var t=this;if(!this.hasEvents){this.hasEvents=!0,this.iframe.addEventListener("load",function(){return t.onLoad()},!1);var o=this.iframe.contentWindow;o&&(this.onbeforeprint&&o.addEventListener("beforeprint",this.onbeforeprint),this.onafterprint&&o.addEventListener("afterprint",this.onafterprint))}},d.prototype.onLoad=function(){var t=this;if(this.iframe){this.isLoading=!1;var o=this.iframe,c=o.contentDocument,p=o.contentWindow;if(!c||!p)return;typeof this.callback=="function"?this.callback({iframe:this.iframe,element:this.elCopy,launchPrint:function(){return t.launchPrint(p)}}):this.launchPrint(p)}},d}();return _.Printd=m,_.default=m,_}var K=pt();class W{static imprimirSalas(i,f,h,b){let g='<table class="table">',u=0;i.forEach(t=>{g+=`
    ...
    `,y+="</table></div>";let L=0,E='<div class="text-h5"><table class="table"><tr style="border-top: 1px solid black; border-bottom: 1px solid black;"><th>Nombre</th><th class="text-right">Cantidad</th></tr>';d.forEach(r=>{E+=`
        <tr style="border-top: 1px solid black; border-bottom: 1px solid black;">
          <td>${r.nombre}</td>
          <td class="text-right">${r.cantidad_total}</td>
        </tr>
        `,L+=parseInt(r.cantidad_total)}),E+=`
      <tr style="border-top: 1px solid black; border-bottom: 1px solid black;">
      <td class="text-right"></td>
      <td class="text-right text-bold">Total</td>
      <td class="text-right text-bold">${L}</td>
      </tr>
    ...
    `;document.getElementById("myElement").innerHTML=I,new K.Printd().print(document.getElementById("myElement"))}static imprimirCaja(i,f,h,b){const g=i.cajas;let u="";g.forEach(t=>{u+=`
      <div>
    ...
    <div>
      ...
      <div><span class="text-bold">Cajas:</span> ${u}</div>
    </div>
    `;document.getElementById("myElement").innerHTML=m,new K.Printd().print(document.getElementById("myElement"))}static numeroALetras(i){if(i=parseInt(i),isNaN(i)||i<0||i>1e6)return"Número fuera de rango";const f=["cero","uno","dos","tres","cuatro","cinco","seis","siete","ocho","nueve"],h=["","","veinte","treinta","cuarenta","cincuenta","sesenta","setenta","ochenta","noventa"],b={10:"diez",11:"once",12:"doce",13:"trece",14:"catorce",15:"quince",16:"dieciséis",17:"diecisiete",18:"dieciocho",19:"diecinueve"},g=["","cien","doscientos","trescientos","cuatrocientos","quinientos","seiscientos","setecientos","ochocientos","novecientos"];function u(c){if(c<10)return f[c];if(c>=10&&c<20)return b[c];if(c<100){const y=c%10;return`${h[Math.floor(c/10)]}${y>0?" y "+f[y]:""}`}if(c===100)return"cien";const p=c%100;return`${g[Math.floor(c/100)]}${p>0?" "+u(p):""}`}if(i===1e6)return"un millón";let m=Math.floor(i/1e3),d=i%1e3,t=m>0?m===1?"mil":`${u(m)} mil`:"",o=d>0?u(d):"";return(t+" "+o).trim()}}const vt={class:"row"},ft={class:"col-12 col-md-2"},ht={class:"col-12 col-md-2"},mt={class:"col-12 col-md-2"},bt={class:"col-12 col-md-2 flex flex-center"},xt={class:"col-12 col-md-2"},gt={class:"col-12 col-md-2 flex flex-center"},yt={class:"col-12 col-md-4"},$t={class:"col-12 col-md-2 flex flex-center"},_t={class:"col-12 col-md-2 flex flex-center"},Ct={class:"row"},kt={class:"col-12 col-md-4 q-pa-xs"},Et={class:"text-weight-bold"},Yt={class:"col-12 col-md-4 q-pa-xs"},wt={class:"text-weight-bold"},At={class:"col-12 col-md-4 q-pa-xs"},Ft={class:"text-weight-bold"},Lt={key:1},Nt={__name:"Ventas",setup(O){const{proxy:i}=lt(),f=$(C().format("YYYY-MM-DD")),h=$(C().format("YYYY-MM-DD")),b=$([]),g=$([]),u=$(!1),m=$(""),d=$([]),t=$(""),o=$("CAJA"),c=$(!1),p=$({}),y=$([]),L=$(["CAJA","PRODUCTOS","SALA"]);st(()=>{N(),P(),E()});function E(){i.$axios.get("/productos").then(v=>{y.value=v.data})}function x(){if(!t.value){i.$alert.error("Seleccione un usuario","Por favor");return}const v=d.value.find(e=>e.id===t.value);u.value=!0,i.$axios.post("/ventas/imprimir",{user_id:t.value,fechaInicio:f.value,fechaFin:h.value,reporte:o.value}).then(e=>{o.value==="CAJA"&&W.imprimirCaja(e.data,f.value,h.value,v.name),o.value==="PRODUCTOS"&&W.imprimirProductos(e.data,f.value,h.value,v.name,y.value),o.value==="SALA"&&W.imprimirSalas(e.data,f.value,h.value,v.name)}).finally(()=>{u.value=!1})}function Y(){c.value=!0,p.value={monto_inicial:0,monto_final:0,observacion:""}}function I(){u.value=!0,i.$axios.post("/cajas",p.value).then(v=>{c.value=!1,i.$alert.success("Registrado correctamente",v.data)}).finally(()=>{u.value=!1})}function T(){b.value=g.value.filter(v=>v.nombre.toLowerCase().includes(m.value.toLowerCase())||v.user?.name.toLowerCase().includes(m.value.toLowerCase())||v.detalleText.toLowerCase().includes(m.value.toLowerCase()))}function r(v){i.$q.dialog({title:"Anular Venta",message:"¿Está seguro de anular la venta?",ok:"Sí",cancel:"No"}).onOk(()=>{u.value=!0,i.$axios.put(`/ventas/${v}/anular`).then(()=>{N()}).finally(()=>{u.value=!1})})}function P(){d.value=[{id:"",name:"Todos"}],i.$axios.get("/users").then(v=>{v.data.forEach(e=>{d.value.push({id:e.id,name:e.name})})})}function N(){u.value=!0,i.$axios.get("/ventas",{params:{fechaInicio:f.value,fechaFin:h.value,user_id:t.value}}).then(v=>{b.value=v.data,g.value=v.data}).finally(()=>{u.value=!1})}return(v,e)=>(k(),Q(tt,null,[a(ct,{class:"q-pa-xs"},{default:n(()=>[a(z,{flat:"",bordered:""},{default:n(()=>[a(U,{class:"q-pa-xs"},{default:n(()=>[a(at,{onSubmit:X(N,["prevent"])},{default:n(()=>[s("div",vt,[s("div",ft,[a(M,{modelValue:f.value,"onUpdate:modelValue":e[0]||(e[0]=l=>f.value=l),label:"Fecha Inicio",type:"date",outlined:"",dense:""},null,8,["modelValue"])]),s("div",ht,[a(M,{modelValue:h.value,"onUpdate:modelValue":e[1]||(e[1]=l=>h.value=l),label:"Fecha Fin",type:"date",outlined:"",dense:""},null,8,["modelValue"])]),s("div",mt,[v.$store.user.role==="Admin"?(k(),A(et,{key:0,modelValue:t.value,"onUpdate:modelValue":e[2]||(e[2]=l=>t.value=l),label:"Usuario",outlined:"",dense:"",options:d.value,"option-label":"name","option-value":"id","emit-value":"","map-options":""},null,8,["modelValue","options"])):B("",!0)]),s("div",bt,[a(F,{style:{width:"150px"},label:"Buscar",color:"primary",type:"submit",icon:"search","no-caps":"",loading:u.value},null,8,["loading"])]),s("div",xt,[v.$store.user.role==="Admin"?(k(),A(et,{key:0,modelValue:o.value,"onUpdate:modelValue":e[3]||(e[3]=l=>o.value=l),label:"Tipo Reporte",outlined:"",dense:"",options:L.value},null,8,["modelValue","options"])):B("",!0)]),s("div",gt,[v.$store.user.role==="Admin"?(k(),A(F,{key:0,style:{width:"150px"},label:"Imprimir",color:"indigo",icon:"print","no-caps":"",loading:u.value,onClick:x},null,8,["loading"])):B("",!0)]),e[11]||(e[11]=s("div",{class:"col-12 col-md-12 flex flex-center"},null,-1)),s("div",yt,[a(M,{modelValue:m.value,"onUpdate:modelValue":[e[4]||(e[4]=l=>m.value=l),T],label:"Filtro",outlined:"",dense:""},null,8,["modelValue"])]),s("div",$t,[a(F,{style:{width:"150px"},label:"Venta",color:"positive",onClick:e[5]||(e[5]=l=>v.$router.push("/ventas/add")),"no-caps":"",icon:"add_circle_outline",loading:u.value},null,8,["loading"])]),e[12]||(e[12]=s("div",{class:"col-12 col-md-4 flex flex-center"},null,-1)),s("div",_t,[a(F,{style:{width:"150px"},label:"Cerrar Caja",color:"red",onClick:Y,"no-caps":"",icon:"point_of_sale",loading:u.value},null,8,["loading"])])])]),_:1}),s("div",Ct,[s("div",kt,[a(J,{bordered:"",padding:"",dense:""},{default:n(()=>[q((k(),A(Z,{clickable:""},{default:n(()=>[a(V,{avatar:""},{default:n(()=>[a(H,{color:"indigo","text-color":"white",icon:"event"})]),_:1}),a(V,null,{default:n(()=>[a(D,{lines:"1"},{default:n(()=>[s("span",Et,w(b.value.length)+" ventas ",1)]),_:1}),a(D,{caption:"",lines:"2"},{default:n(()=>e[13]||(e[13]=[j(" Cantida de ventas ")])),_:1})]),_:1})]),_:1})),[[G]])]),_:1})]),s("div",Yt,[a(J,{bordered:"",padding:"",dense:""},{default:n(()=>[q((k(),A(Z,{clickable:""},{default:n(()=>[a(V,{avatar:""},{default:n(()=>[a(H,{color:"green","text-color":"white",icon:"attach_money"})]),_:1}),a(V,null,{default:n(()=>[a(D,{lines:"1"},{default:n(()=>[s("span",wt," Bs "+w(b.value.filter(l=>!l.anulada).reduce((l,S)=>l+parseFloat(S.total),0).toFixed(2)),1)]),_:1}),a(D,{caption:"",lines:"2"},{default:n(()=>e[14]||(e[14]=[j(" Total de reservas ")])),_:1})]),_:1})]),_:1})),[[G]])]),_:1})]),s("div",At,[a(J,{bordered:"",padding:"",dense:""},{default:n(()=>[q((k(),A(Z,{clickable:""},{default:n(()=>[a(V,{avatar:""},{default:n(()=>[a(H,{color:"red","text-color":"white",icon:"cancel"})]),_:1}),a(V,null,{default:n(()=>[a(D,{lines:"1"},{default:n(()=>[s("span",Ft," Bs "+w(b.value.filter(l=>l.anulada).reduce((l,S)=>l+parseFloat(S.total),0).toFixed(2)),1)]),_:1}),a(D,{caption:"",lines:"2"},{default:n(()=>e[15]||(e[15]=[j(" Total de reservas canceladas ")])),_:1})]),_:1})]),_:1})),[[G]])]),_:1})])])]),_:1})]),_:1}),a(z,{flat:"",bordered:"",class:"q-mt-md"},{default:n(()=>[a(U,null,{default:n(()=>[a(nt,{"wrap-cells":"",dense:"",flat:"",bordered:""},{default:n(()=>[e[16]||(e[16]=s("thead",null,[s("tr",null,[s("th",null,"Acciones"),s("th",null,"Fecha"),s("th",null,"Total"),s("th",null,"Nombre Cliente"),s("th",null,"Usuario"),s("th",null,"Detalle")])],-1)),s("tbody",null,[(k(!0),Q(tt,null,it(b.value,l=>(k(),Q("tr",{key:l.id},[s("td",null,[l.anulada?(k(),Q("div",Lt,[a(dt,{color:"red","text-color":"white",label:"Anulada"})])):(k(),A(F,{key:0,style:{width:"80px"},icon:"remove_circle_outline",color:"negative",dense:"",onClick:S=>r(l.id),label:"Anular","no-caps":"",size:"10px"},null,8,["onClick"]))]),s("td",null,w(l.fecha),1),s("td",null,w(l.total),1),s("td",null,w(l.nombre),1),s("td",null,w(l.user?.name),1),s("td",null,w(l.detalleText),1)]))),128))])]),_:1})]),_:1})]),_:1})]),_:1}),a(rt,{modelValue:c.value,"onUpdate:modelValue":e[10]||(e[10]=l=>c.value=l),persistent:""},{default:n(()=>[a(z,{flat:"",bordered:"",style:{width:"350px"}},{default:n(()=>[a(U,{class:"row items-center q-pb-none"},{default:n(()=>[e[17]||(e[17]=s("div",{class:"text-bold"}," Cerrar Caja ",-1)),a(ut),a(F,{flat:"",dense:"",icon:"close",onClick:e[6]||(e[6]=l=>c.value=!1)})]),_:1}),a(U,null,{default:n(()=>[a(at,{onSubmit:X(I,["prevent"])},{default:n(()=>[a(M,{modelValue:p.value.monto_inicial,"onUpdate:modelValue":e[7]||(e[7]=l=>p.value.monto_inicial=l),label:"Monto Inicial",type:"number",outlined:"",dense:"",hint:""},null,8,["modelValue"]),a(M,{modelValue:p.value.monto_final,"onUpdate:modelValue":e[8]||(e[8]=l=>p.value.monto_final=l),label:"Monto Final",type:"number",outlined:"",dense:"",hint:""},null,8,["modelValue"]),a(M,{type:"textarea",modelValue:p.value.observacion,"onUpdate:modelValue":e[9]||(e[9]=l=>p.value.observacion=l),label:"Observación",outlined:"",dense:"",hint:""},null,8,["modelValue"]),a(F,{label:"Cerrar Caja",color:"red",type:"submit",loading:u.value},null,8,["loading"])]),_:1})]),_:1})]),_:1})]),_:1},8,["modelValue"]),e[18]||(e[18]=s("div",{id:"myElement"},null,-1))],64))}};export{Nt as default};
